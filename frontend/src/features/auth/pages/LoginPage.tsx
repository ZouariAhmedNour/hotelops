...
const LoginPage = () => {
  ...
  const getErrorMessage = (err: unknown) => {
    if (typeof err === "object" && err !== null && "response" in err) {
      ...
      return e.response?.data?.message || "Erreur de connexion";
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="h-[52px] w-full border border-slate-200 bg-white px-4 text-[15px] outline-none transition placeholder:text-slate-300 focus:border-[#13234b]"
                  required
                />
              </div>
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-[13px] font-semibold text-[#13234b] hover:underline"
                  >
                    Mot de passe oublié ?
                  </button>
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="h-[52px] w-full border border-slate-200 bg-white px-4 pr-12 text-[15px] outline-none transition placeholder:text-slate-300 focus:border-[#13234b]"
                    required
                  />
